...
label main1:
    ...
    n "He doesn’t have the energy to wonder why Hunk feels up for puttering around in the kitchen when all he can do is lean heavily 
    on the counter while his eyelids droop."
    n "He’s been on one too many deadly recon missions running for his life and too many crusty diplomatic dinners where he’s left to 
    stare at the ceiling while looking pretty so Allura can do all the talking. 
